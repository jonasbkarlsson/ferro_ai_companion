...
class OperationSettings:
    ...
    async def determine_mode(
        ...
        if discharge_threshold_w > 4 and charge_threshold_w in list(range(4)):
            return MODE_PEAK_CHARGE
        elif discharge_threshold_w > 4 and charge_threshold_w > 4:
            return MODE_BUY
        elif discharge_threshold_w > 4 and charge_threshold_w < 0:
            return MODE_PEAK_SELL
        elif discharge_threshold_w < 0 and charge_threshold_w < 0:
            return MODE_SELL
        else:
            # discharge_threshold_w in list(range(4)) and charge_threshold_w in list(range(4))
            # discharge_threshold_w in list(range(4)) and charge_threshold_w < 0
            return MODE_SELF
